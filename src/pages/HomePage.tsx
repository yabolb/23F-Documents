...
import { Filter, Archive, Info, Search, X, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-paper selection:bg-sepia-900 selection:text-paper pb-20">
      ...
      <header className="bg-sepia-900 text-paper py-12 md:py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <Link
            to="/explicacion"
            className="inline-flex items-center gap-2 px-6 py-3 bg-paper text-sepia-900 rounded-full font-serif font-bold hover:bg-paper/90 transition-colors shadow-lg mb-8 group"
          >
            <BookOpen size={20} />
            <span>Ver Explicación Cronológica de los Hechos</span>
